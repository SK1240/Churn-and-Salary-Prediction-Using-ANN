...
with open('salary_prediction_models/ohe_geo_salary.pkl','rb') as file:
    ohe_geo=pickle.load(file)
with open('salary_prediction_models/le_gender_salary.pkl','rb') as file:
    le_gender=pickle.load(file)
with open('salary_prediction_models/scaler_salary.pkl','rb') as file:
