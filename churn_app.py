...
with open('churn_prediction_models/ohe_geo.pkl','rb') as file:
    ohe_geo=pickle.load(file)
with open('churn_prediction_models/le_gender.pkl','rb') as file:
    le_gender=pickle.load(file)
with open('churn_prediction_models/scaler.pkl','rb') as file:
